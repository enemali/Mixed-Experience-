  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-400 via-pink-500 to-blue-600 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex flex-row gap-1 px-2 max-w-full overflow-hidden">
        ...
        {/* Left Sidebar */}
        <div className="flex flex-col gap-2 p-4 bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 min-w-[160px] max-w-[180px] overflow-y-auto">
